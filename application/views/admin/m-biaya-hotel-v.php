<div style="margin-top: 14px; background-color: white;padding: 30px">
	...
	<div class="media-body">
		...
		<div class="media-right">
			<button type="button" class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#addmasterbiayahotel"><i class="material-icons">note_add</i> Tambah Data </button>
		</div>
	</div>
	<hr/>
			<table class="table">
				...
				<?php foreach ($hasil as $data): ?>
					<tr>
						...
						<td><a href="<?php echo base_url('index.php/admin/master/edit/biaya_hotel/'.$data->id_biaya_hotel) ?>">Edit</a></td>
						<td><a href="<?php echo base_url('index.php/admin/master/delete/biaya_hotel/'.$data->id_biaya_hotel) ?>">Hapus</td>
					</tr>
					<?php $no++ ?>
				<?php endforeach ?>
			</table>
