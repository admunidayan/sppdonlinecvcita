...
<body onload="window:print()">
	<div class="container-fluid" style="font-size: 11px">
		<div class="row" style="border-bottom:1px solid">
			<div class="col-2"><img src="<?php echo base_url('asset/img/lembaga/'.$infopt->logo_pt) ?>" width="100px"></div>
			<div class="col-10 text-center">
				<b>PEMERINTAH KABUPATEN BUTON TENGAH 
				BADAN KEPEGAWAIAN DAN PENGEMBANGAN SDM</b><br/>
